...
> **팁**: Power BI Desktop에서는 *Power BI dataflows (Legacy)* 커넥터를 사용하여 데이터 흐름으로 수행된 데이터 변환에 직접 연결할 수 있습니다.
>
> 또한 추가 변환을 수행하고, 새 데이터 세트로 게시하고, 전문화된 데이터 세트를 위해 의도된 대상과 배포할 수 있습니다.
>
>![Power BI 데이터 소스 커넥터](Images/pbid-dataflow-connectors.png)
